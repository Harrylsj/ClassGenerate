...
namespace ClassGenerate.Proc
{
    public class Generator
    {
        ...
        public void Toashx(bool confirmWrite, List<string> tablesName)
        {
            ToAddashx(confirmWrite, tablesName);
            ToUpdateashx(confirmWrite, tablesName);
            ToDeleteashx(confirmWrite, tablesName);
            ToGetashx(confirmWrite, tablesName);
            ToGetCountashx(confirmWrite, tablesName);
        }
        public string ToAddashx(bool confirmWrite, List<string> tablesName)
        {
            StringBuilder ret = new StringBuilder();
            ProcTable pt = new ProcTable();
            ProcString ps = new ProcString();
            ...
            foreach (string tableName in tablesName)
            {
                ...
                //    MessageBox.Show("JHPIX_PAT_MASTER_INDEX类的GetUpdateSQL方法特殊！不可自动生成");
                string strClass = "";
                TableInfo tableInfo = new TableInfo("", strPrefix, tableName);
                DataSet dsTableInfo = tableInfo.dsTableInfo;
                DataTable dtColumnType = dsTableInfo.Tables[1];
                //DataColumnCollection dtcols = dtColumnType.Columns;
                DataTable dtColumnsDescription = null;
                ...
                //缺少主键校验
                strClass = pt.GetTableAddashx(dtColumnType, dtColumnsDescription
                    , tableDecription
                    , strPrefix, strNameSpace);
                ret.AppendLine(strClass);
                #region 写文件
                if (confirmWrite)
                {
                    ...
                    string className = ps.GetClassNameByTableName(tableName, strPrefix.Trim());//类名大写 
                    //className = ps.GetClassName(className);//lsj
                    string fullPath = tem +"Add" + className + ".ashx";//2021-2-2-lsj-首字母大写
        ...
        public string ToUpdateashx(bool confirmWrite, List<string> tablesName)
        {
            StringBuilder ret = new StringBuilder();
            ProcTable pt = new ProcTable();
            ProcString ps = new ProcString();
            ...
            foreach (string tableName in tablesName)
            {
                ...
                //缺少主键校验
                strClass = pt.GetTableUpdateashx(dtColumnType, dtColumnsDescription , tableDecription, strPrefix, strNameSpace);
                ret.AppendLine(strClass);
                #region 写文件
                if (confirmWrite)
                {
                    ...
                    string className = ps.GetClassNameByTableName(tableName, strPrefix.Trim());//类名大写 
                    //className = ps.GetClassName(className);//lsj
                    string fullPath = tem + "Udpate" + className + ".ashx";//2021-2-2-lsj-首字母大写
        ...
        public string ToDeleteashx(bool confirmWrite, List<string> tablesName)
        {
            StringBuilder ret = new StringBuilder();
            ProcTable pt = new ProcTable();
            ProcString ps = new ProcString();
            ...
            foreach (string tableName in tablesName)
            {
                ...
                //缺少主键校验
                strClass = pt.GetTableDeleteashx(dtColumnType, dtColumnsDescription, tableDecription, strPrefix, strNameSpace);
                ret.AppendLine(strClass);
                #region 写文件
                if (confirmWrite)
                {
                    ...
                    string className = ps.GetClassNameByTableName(tableName, strPrefix.Trim());//类名大写 
                    //className = ps.GetClassName(className);//lsj
                    string fullPath = tem + "Delete" + className + ".ashx";//2021-2-2-lsj-首字母大写
        ...
        public string ToGetashx(bool confirmWrite, List<string> tablesName)
        {
            StringBuilder ret = new StringBuilder();
            ProcTable pt = new ProcTable();
            ProcString ps = new ProcString();
            ...
            foreach (string tableName in tablesName)
            {
                ...
                //缺少主键校验
                strClass = pt.GetTableGetashx(dtColumnType, dtColumnsDescription, tableDecription, strPrefix, strNameSpace);
                ret.AppendLine(strClass);
                #region 写文件
                if (confirmWrite)
                {
                    ...
                    string className = ps.GetClassNameByTableName(tableName, strPrefix.Trim());//类名大写 
                    //className = ps.GetClassName(className);//lsj
                    string fullPath = tem + "Get" + className + ".ashx";//2021-2-2-lsj-首字母大写
        ...
        public string ToGetCountashx(bool confirmWrite, List<string> tablesName)
        {
            StringBuilder ret = new StringBuilder();
            ProcTable pt = new ProcTable();
            ProcString ps = new ProcString();
            ...
            foreach (string tableName in tablesName)
            {
                ...
                //缺少主键校验
                strClass = pt.GetTableGetCountashx(dtColumnType, dtColumnsDescription, tableDecription, strPrefix, strNameSpace);
                ret.AppendLine(strClass);
                #region 写文件
                if (confirmWrite)
                {
                    ...
                    string className = ps.GetClassNameByTableName(tableName, strPrefix.Trim());//类名大写 
                    //className = ps.GetClassName(className);//lsj
                    string fullPath = tem + "Get" + className + "sCount.ashx";//2021-2-2-lsj-首字母大写
